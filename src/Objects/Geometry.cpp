...
/**
 * Adds a vertex, associated texture coordinates, and normals.
 * Sets placeholder values for tangent and bi-tangent
 */
 ...
 * Sets placeholder values for normal, tangent, and bi-tangent
 */
...
void Geometry::MakeTriangle(unsigned int vert0, unsigned int vert1, unsigned int vert2) {
	...
	// Define the same two edges in texture coordinates
